...
public class ProductDetailDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        imagePanel.setPreferredSize(new Dimension(280, 200)); // Thêm kích thước cụ thể cho imagePanel
        
        JLabel imageLabel = new JLabel(sanPham.getProductName(), SwingConstants.CENTER);
